...
import { JobStatus, Job } from '../interfaces/Job.js';
...
export const jobRepo = {
    ...
    async create(employer_id: number, category_id: number, title: string, description: string, budget: number, status: JobStatus, deadline: string): Promise<number | null> {
    ...
    async update(job_id: number, updateData: { employer_id?: number, category_id?: number, title?: string, description?: string, budget?: number, status?: JobStatus, deadline?: string}): Promise<boolean> {
